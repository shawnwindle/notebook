...
namespace SW\Notebook\Relations;
...
class BelongsToManyAll extends Relation
{
    ...
    protected function performJoin($query = null)
    {
        ...
        //CHANGE: change join() to leftJoin()
        $query->leftJoin($this->table, $key, '=', $this->getQualifiedRelatedKeyName());
